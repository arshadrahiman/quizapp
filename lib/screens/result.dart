    ...
    return Scaffold(
          body: Center(
            child: Column(mainAxisSize:MainAxisSize.min,
                ...
                children: [Text(widget.score>3?"C o n g r a t u l a t i o n s . . . ! !":"Better Luck Next Time..",style: TextStyle(color:widget.score>3?Colors.green:Colors.red,fontSize:22 ,fontWeight: FontWeight.normal),),
                  SizedBox(height: 30,),
